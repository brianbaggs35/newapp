class CreateQaPlatformTables < ActiveRecord::Migration[8.0]
  def change
    ...
    create_table :manual_test_run_items, id: false do |t|
      ...
      t.references :manual_test_case, type: :uuid, null: false, foreign_key: true
      t.references :organization, type: :uuid, null: false, foreign_key: true
      t.references :executed_by, type: :uuid, null: true, foreign_key: { to_table: :users }
      t.string :status, default: 'to_do', null: false
    ...
    add_index :failure_analyses, :assigned_to_id
    ...
    add_index :manual_test_run_items, :executed_by_id
  end
end